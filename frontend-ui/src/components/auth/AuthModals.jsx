  ...
  return (
    <>
      <a
        ...
        className="w-100 py-2 mb-2 btn btn-outline-secondary rounded-3 d-flex align-items-center justify-content-center gap-2"
      >
      ...
      <a
        ...
        className="w-100 py-2 mb-2 btn btn-dark rounded-3"
      >
